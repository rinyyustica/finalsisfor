                             ...
                             <tbody>
                                    <?php 
                                        ...
                                        foreach ($query->result() as $baris) {
                                            ...
                                            echo "<td>".$baris->no_telp."</td>";
                                            echo "<td>".$baris->instagram."</td>";
                                            echo "<td>".$baris->tanggal_lahir."</td>";
                                            echo "<td>".$baris->pekerjaan."</td>";
                                            echo "<td>".$baris->instansi."</td>";
                                            echo "<td>
                                                    <a href=".base_url('index.php/admin/edit/').$baris->id_customer." >
                                                    <button type='button' class='btn btn-success waves-effect'>
                                                    <i class='material-icons'>edit</i></button></a></td>";
                                            echo "<td >
                                                    <a href=".base_url('index.php/admin/hapus/').$baris->id_customer." >
